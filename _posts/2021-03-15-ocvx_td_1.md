...
ensemble des vecteurs tels que $$\text{{}x\in\mathbb R\vert<x.y>\ge0\text{}}$$
</div>

$y\neq0$ et $$\text{{}y\text{}}=\text{{}x\in\mathbb R^2\vert<x.y>=0\text{}}$$
...
$$
\begin{aligned}
(D)&=\text{{}x\in\mathbb R^2,x=\lambda u,\lambda\in\mathbb R\text{}}\\
&= \text{{}\lambda\vec u,\lambda\in\mathbb R\text{}} \text{ representation parametrique}\\
&= \text{{}\vec x\in\mathbb R^2,<\vec n,\vec x>=0\text{}}\\
&=\text{{}n^Tx=0\text{}}\\
&=\text{{}n_1x_1+n_2x_2=0\text{}} = \text{ representation implicite}\\
\end{aligned}\\
n=\begin{pmatrix}
    n_1\\
    n_2\\
...
$$
\begin{aligned}
(A)&=(0,1)+(D) = (0,1)+\text{{}\lambda\vec u,\lambda\in\mathbb R\text{}} \text{ avec }  \vec u=\begin{pmatrix}
    u_1\\
    u_2\\
\end{pmatrix}\\
&= (0,1)+\text{{}(\lambda u_1,\lambda u_2),\lambda\in\mathbb R\text{}}\\
&= \text{{}(0,1)+(\lambda u_1,\lambda u_2),\lambda\in\mathbb R\text{}}=\text{{}(\lambda u_1, 1+\lambda u_2),\lambda\in\mathbb R\text{}}
\end{aligned}
$$
...
$$
\begin{aligned}
(A) &= (2,3)+\text{{}\vec x\in\mathbb R^2, \vec x=\lambda\vec u,\lambda\in\mathbb R\text{}}\\
&= (2,3) + \text{{}(\lambda,-\lambda),\lambda\in\mathbb R\text{}}\\
&= \text{{}(2,3)+(\lambda,-\lambda),\lambda\in\mathbb R\text{}}\\
&= \text{{}(2+\lambda,3-\lambda),\lambda\in\mathbb R\text{}}
\end{aligned}
$$
...
&= (2,0,0)+\text{{}\vec{x}\in\mathbb R^3,\vec{x}=\lambda_1\vec{AB}+\lambda_2\vec{AC},(\lambda_1,\lambda_2)\in\mathbb R^2\text{}}\\
&= (2,0,0)+\text{{}\lambda_1(-2,2,0)+\lambda_2(-2,0,2),(\lambda_1,\lambda_2)\in\mathbb R^2\text{}}\\
&= (2,0,0)+\text{{}(-2\lambda_1-2\lambda_2,2\lambda_1,2\lambda_2), (\lambda_1,\lambda_2)\in\mathbb R^2\text{}}\\
&= \text{{}(2-2\lambda_1-2\lambda_2,2\lambda_1,\lambda_2) (\lambda_1,\lambda_2)\in\mathbb R^2\text{}}
\end{aligned}
$$
